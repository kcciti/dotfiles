...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ;;(ess :variables
     ;;     ess-r-backend 'lsp
     ;;     inferior-R-program-name "~/Downloads/r.sh" 
     ;;     )
     (python :variables
...
before packages are loaded."
  (key-chord-mode 1)
  (key-chord-define evil-insert-state-map "qq" 'evil-escape)
  (unbind-key (kbd "q") evil-normal-state-map)
  (define-key evil-normal-state-map (kbd "qj") 'evil-window-down)
  (define-key evil-normal-state-map (kbd "qk") 'evil-window-up)
  (define-key evil-normal-state-map (kbd "qh") 'evil-window-left)
  (define-key evil-normal-state-map (kbd "ql") 'evil-window-right)
